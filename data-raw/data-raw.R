...
adams_bt_03 <- ypr_population(k = 0.13, Linf = 131, t0 = 0.2, b = 3.4,
                              Lm = 40, Lv = 40, nu = 0.3, mu = 0.06,
                              eta = 0.15,
                              Rk = 3.8)
...
kootenay_rb_13 <- ypr_population(k = 0.25, t0 = 0.75, b = 3.39,
                                 Lm = 60,
                                 Lv = 40, nu = 0.38, mu = 0.1, Rk = 10)

quesnel_bt <- ypr_population(k = 0.13, Linf = 1000, b = 3.4,
                             Lv = 400, nu = 0.3, mu = 0.06, Rk = 3.8)

quesnel_lt <- ypr_population(k = 0.15, Linf = 1000, b = 3.1,
                             Lv = 400, nu = 0.15, mu = 0.04, Rk = 2.5)

quesnel_rb <- ypr_population(k = 0.2, Linf = 1000, b = 3,
