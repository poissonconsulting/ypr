...
adams_bt_03 <- ypr_population(k = 0.13, Linf = 131, t0 = 0.2, Wb = 3.4,
                              Lm = 40, Lv = 40, M = ypr_interval2instant(0.3), pi = 0.06,
                              Hm = 0.15,
                              Rk = 3.8, Vp = 5)
...
quesnel_bt <- ypr_population(k = 0.13, Linf = 1000, Wb = 3.4,
                             Lv = 400, M = ypr_interval2instant(0.3), pi = 0.06, Rk = 3.8)

quesnel_lt <- ypr_population(k = 0.15, Linf = 1000, Wb = 3.1,
                             Lv = 400, M = ypr_interval2instant(0.15), pi = 0.04, Rk = 2.5)

quesnel_rb <- ypr_population(k = 0.2, Linf = 1000, Wb = 3,
                             Lv = 400, M = ypr_interval2instant(0.5), pi = 0.14, Rk = 6)
