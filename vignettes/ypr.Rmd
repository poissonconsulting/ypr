...
The number of recruits at the unfished equilibrium ($R_0$) is a scaling constant that only affects the estimate of the yield.
...
where $L_y$ is the minimun length of a trophy fish.
