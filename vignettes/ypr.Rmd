...
In `ypr` length (in cm) at age ($t$) is assumed to follow a Von Bertalanffy growth curve of the form
...
```{r, fig.width=4}
population <- ypr_population_update(population, M = 0.2, Mb = -0.75)
...
```{r, fig.width=4}
population <- ypr_population_update(population, Lv = 50, Vp = 10)
