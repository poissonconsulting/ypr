...
Yield per recruit methods can used to estimate the optimal yield for a fish population [@walters_fisheries_2004] or multiple ecotypes.
...
- The relative proportion of recruits that belong to that ecotype and which is assumed to be independent of parent ecotype (`RPR`)
