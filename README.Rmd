...
The yield can be based on the number of fish caught (or harvested) or biomass caught (or harvested) for all fish or just large (trophy) individuals.
The yield (and optimal capture rate) can be calculated with lower and upper limits that represent the uncertainty in one or more population parameters.
...
There are 18 additional advanced parameters and three scaling parameters.
From more information type `?ypr_population`.
