...
The methods suffers from the same limitations as all yield per recruit methods.
In particular, they do not account for population fluctuations, food-web responses or density-dependent growth.
