...
test_that("as.data.frame", {
  expect_identical(as.data.frame(ypr_population()),
    ...
    pi = 0.2, rho = 0, Hm = 0, Rmax = 1, Wa = 0.01, fa = 1, q = 0.1), class = c("tbl_df",
...
test_that("unique", {
  ...
  expect_identical(unique(pops), structure(list(Popn_1 = structure(list(tmax = 20L, k = 0.15,
