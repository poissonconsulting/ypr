...
test_that("yield", {
  ...
  expect_equal(ypr_yield(ypr_population(), biomass = TRUE), 9.256122, tolerance = 1e-06, check.attributes = FALSE)
  expect_equal(ypr_yield(ypr_population(), biomass = TRUE, Ly = 70), 3.25123, tolerance = 1e-06, check.attributes = FALSE)
})
