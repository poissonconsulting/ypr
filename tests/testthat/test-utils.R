...
test_that("ypr_length_at_age with biphasic growth and t0 != 0", {
  ...
  expect_equal(length0,
               c(7.56017235610119, 22.723028948946, 31.5591571294237, 36.7083953843497,
                 39.709104978465, 41.4577632503176, 42.4767908022391, 43.0706273272422,
                 43.4166845243837))

  expect_equal(length1,
               c(7.56017235610119, 22.723028948946, 31.5591571294237, 46.5956394711933,
                 64.7006271011388, 73.6912978834949, 78.1559328652398, 80.3730049839673,
                 81.4739704155731))

  expect_equal(length2,
               c(7.56017235610119, 22.723028948946, 31.5591571294237, 36.9426448489903,
